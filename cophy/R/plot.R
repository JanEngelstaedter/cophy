...
#' @param TraitTracking: an object that tracks the evolution of host resistance traits if available.
...
plot.cophylo<-function(cophy, ParasiteCol=c("Red", "Blue"), TraitTracking=NA, ResistanceCol="lawn green")
{
  Hphy<-cophy[[1]]
  Pphy<-cophy[[2]]
