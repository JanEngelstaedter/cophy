...
This output can then be passed to the `phytools` function `cophylo` [@Revell2012]. This function plots the pruned host and parasite trees with connector lines expressing the terminal host-parasite associations. An example of this can be seen bellow:
